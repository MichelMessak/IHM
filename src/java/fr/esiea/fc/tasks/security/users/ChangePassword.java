package fr.esiea.fc.tasks.security.users;
...
public class ChangePassword extends SimpleFormController {
    ...
    protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws Exception {
        try {
            ...
            if (!UserDAO.changePassword(user)) {
                ...
                ActivityDAO.insert(user.getId(), "Echec lors de la modification du mot de passe de l'utilisateur " + user.getId(), userIp);
                return this.showForm(request, response, errors);
            }*/
            ...
            mv.addObject("message", "Le mot de passe a été changé");
            return mv;
        } catch (Exception ex) {
            Log.write(ex);
    ...
    protected Object formBackingObject(HttpServletRequest request) throws Exception 
    {
        ...
        user.setId(SessionManager.getUserID(request));
        return user;
    }
